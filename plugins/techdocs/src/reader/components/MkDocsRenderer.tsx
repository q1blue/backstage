...
export const MkDocsRenderer = ({
  ...
  useEffect(() => {
    console.log('MkDocsRender Render');
    ...
    // Hide root before replacing it with the new content to avoid flash of
    // unstyled content
    shadowDiv.style.setProperty('opacity', '0');
    ...
    transformer(shadowRoot.children[0], [
      ...
      onCssReady({
        ...
        onLoaded: (dom: Element) => {
          shadowDiv.style.removeProperty('opacity');
